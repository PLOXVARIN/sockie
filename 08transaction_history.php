...
//         received_by AS person_responsible
//     FROM transfer_in_header
//     WHERE transfer_in_id LIKE '%$search_query%'
//     UNION
//     SELECT 
...
//         send_by AS person_responsible
//     FROM transfer_out_header
//     WHERE transfer_out_id LIKE '%$search_query%'
//     ORDER BY transfer_date DESC
// ";
$sql = "
    SELECT 
        transfer_in_id AS transfer_id, -- เพิ่มคอลัมน์ transfer_id
    ...
    UNION ALL
    SELECT 
        transfer_out_id AS transfer_id, -- เพิ่มคอลัมน์ transfer_id
        transfer_date AS date,
        from_location AS source,
        to_location AS destination,
        total_quantity AS total_quantity,
